...
[0] = LAYOUT(
	...
	KC_LCTL,	    KC_LALT,	KC_LGUI,									LT(1,KC_SPC), 							KC_RGUI,	TT(1),   	KC_LEFT,	KC_DOWN,    KC_RGHT),
...
[1] = LAYOUT(
	...
	_______, 	_______,   	_______,   	_______,  	_______,   	_______,   	_______,   	_______,   	_______,   	_______,  	_______,   	_______,	            RGB_RMOD,
	_______,    _______,   	_______,   	_______,  	_______,   	_______,   	_______,   	TT(6),   	RGB_SPD,	RGB_SPI,  	_______,	TT(2),  	RGB_VAI,    _______,
	_______,	_______,	_______,										BAT_SHOW, 							_______,	_______,   	RGB_MOD,	RGB_VAD,    RGB_HUI),
...
// layer 3 Win
[3] = LAYOUT(
	LT(4,KC_ESC), 	KC_1,   	KC_2,   	KC_3,  		KC_4,   	KC_5,   	KC_6,   	KC_7,   	KC_8,   	KC_9,  		KC_0,   	KC_MINS,	KC_EQL, 	KC_BSPC,
	KC_TAB, 	    KC_Q,   	KC_W,   	KC_E,  		KC_R,   	KC_T,   	KC_Y,   	KC_U,   	KC_I,   	KC_O,  		KC_P,   	KC_LBRC,	KC_RBRC, 	KC_BSLS,
	KC_CAPS,	    KC_A,   	KC_S,   	KC_D,  		KC_F,   	KC_G,   	KC_H,   	KC_J,   	KC_K,   	KC_L,  		KC_SCLN,	KC_QUOT, 	            KC_ENT,
	KC_LSFT,	    KC_Z,   	KC_X,   	KC_C,  		KC_V,   	KC_B,   	KC_N,   	KC_M,   	KC_COMM,	KC_DOT,		KC_SLSH,	KC_RSFT,	KC_UP,		KC_DEL,
	KC_LCTL,	    KC_LGUI,	KC_LALT,									LT(4,KC_SPC), 							KC_RALT,	TT(4),   	KC_LEFT,	KC_DOWN,    KC_RGHT),
...
[4] = LAYOUT(
	...
	_______, 	LNK_BLE1,  	LNK_BLE2,  	LNK_BLE3,  	LNK_RF,   	_______,   	_______,   	_______,   	_______,   	_______,  	_______,   	DEV_RESET,	SLEEP_MODE, BAT_SHOW,
	_______, 	_______,   	_______,   	_______,  	_______,   	_______,   	_______,   	_______,   	_______,   	_______,  	_______,   	_______,	            _______,
	_______,	_______,   	_______,   	_______,  	_______,   	_______,   	_______,   	TT(6),   	RGB_SPD,	RGB_SPI,  	_______,	TT(5),  	RGB_VAI,    _______,
	_______,	_______,	_______,										BAT_SHOW, 							_______,	_______,   	RGB_MOD,	RGB_VAD,    RGB_HUI),
